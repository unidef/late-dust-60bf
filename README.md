...
```
npm create cloudflare@latest -- --template=cloudflare/templates/late-dust-60bf
```

A live public deployment of this template is available at [https://late-dust-60bf.templates.workers.dev](https://late-dust-60bf.templates.workers.dev)
